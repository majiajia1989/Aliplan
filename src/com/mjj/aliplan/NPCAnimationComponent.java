...
import com.mjj.aliplan.ChannelSystem.Channel;
...
public class NPCAnimationComponent extends GameComponent {
	...
	private boolean mStopAtWalls; // Controls whether or not the character will
									// go back
	...
	protected boolean shouldFall(GameObject parentObject) {
		...
		final float airTime = time.getGameTime()
				- parentObject.getLastTouchedFloorTime();
