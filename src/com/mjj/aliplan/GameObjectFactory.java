...
import com.mjj.aliplan.AnimationPlayerActivity;
import com.mjj.aliplan.AnimationComponent.PlayerAnimations;
import com.mjj.aliplan.CollisionParameters.HitType;
import com.mjj.aliplan.EnemyAnimationComponent.EnemyAnimations;
import com.mjj.aliplan.GameObject.ActionType;
import com.mjj.aliplan.GameObject.Team;
import com.mjj.aliplan.GenericAnimationComponent.Animation;
...
public class GameObjectFactory extends BaseObject {
	...
	public enum GameObjectType {
		...
		// Characters
		WANDA(10), KYLE(11), KYLE_DEAD(12), ANDOU_DEAD(13), KABOCHA(26), ROKUDOU_TERMINAL(
				27), KABOCHA_TERMINAL(28), EVIL_KABOCHA(29), ROKUDOU(30),

		// AI
		BROBOT(16), SNAILBOMB(17), SHADOWSLIME(18), MUDMAN(19), SKELETON(20), KARAGUIN(
				21), PINK_NAMAZU(22), TURRET(23), TURRET_LEFT(24), BAT(6), STING(
				7), ONION(8),

		// Objects
		DOOR_RED(32), DOOR_BLUE(33), DOOR_GREEN(34), BUTTON_RED(35), BUTTON_BLUE(
				36), BUTTON_GREEN(37), CANNON(38), BROBOT_SPAWNER(39), BROBOT_SPAWNER_LEFT(
				40), BREAKABLE_BLOCK(41), THE_SOURCE(42), HINT_SIGN(43),

		// Effects
		DUST(48), EXPLOSION_SMALL(49), EXPLOSION_LARGE(50), EXPLOSION_GIANT(51),

		// Special Spawnable
		DOOR_RED_NONBLOCKING(52), DOOR_BLUE_NONBLOCKING(53), DOOR_GREEN_NONBLOCKING(
				54),
		...
		// Projectiles
		ENERGY_BALL(68), CANNON_BALL(65), TURRET_BULLET(66), BROBOT_BULLET(67), BREAKABLE_BLOCK_PIECE(
				68), BREAKABLE_BLOCK_PIECE_SPAWNER(69), WANDA_SHOT(70),
		...
		PLAYER_JETS(-1), PLAYER_SPARKS(-1), PLAYER_GLOW(-1), ENEMY_SPARKS(-1), GHOST(
				-1), SMOKE_POOF(-1), GEM_EFFECT(-1), GEM_EFFECT_SPAWNER(-1),
	...
	public GameObject spawn(GameObjectType type, float x, float y,
		...
		case TURRET:
		case TURRET_LEFT:
			newObject = spawnObjectTurret(x, y,
					(type == GameObjectType.TURRET_LEFT));
			break;
		case DOOR_RED:
		case DOOR_RED_NONBLOCKING:
			newObject = spawnObjectDoor(x, y, GameObjectType.DOOR_RED,
					(type == GameObjectType.DOOR_RED));
			break;
		case DOOR_BLUE:
		case DOOR_BLUE_NONBLOCKING:
			newObject = spawnObjectDoor(x, y, GameObjectType.DOOR_BLUE,
					(type == GameObjectType.DOOR_BLUE));
			break;
		case DOOR_GREEN:
		case DOOR_GREEN_NONBLOCKING:
			newObject = spawnObjectDoor(x, y, GameObjectType.DOOR_GREEN,
					(type == GameObjectType.DOOR_GREEN));
			break;
		case BUTTON_RED:
		...
		case BROBOT_SPAWNER_LEFT:
			newObject = spawnObjectBrobotSpawner(x, y,
					(type == GameObjectType.BROBOT_SPAWNER_LEFT));
			break;
	...
	public GameObject spawnPlayer(float positionX, float positionY) {
		...
		if (staticData == null) {
			...
			// Animation Data
			FixedSizeArray<CollisionVolume> basicVulnerabilityVolume = new FixedSizeArray<CollisionVolume>(
					1);
			basicVulnerabilityVolume.add(new SphereCollisionVolume(16, 32, 32));

			FixedSizeArray<CollisionVolume> pressAndCollectVolume = new FixedSizeArray<CollisionVolume>(
					2);
			AABoxCollisionVolume collectionVolume = new AABoxCollisionVolume(
					16, 0, 32, 48);
			collectionVolume.setHitType(HitType.COLLECT);
			pressAndCollectVolume.add(collectionVolume);
			AABoxCollisionVolume pressCollisionVolume = new AABoxCollisionVolume(
					16, 0, 32, 16);
			...
			SpriteAnimation idle = new SpriteAnimation(
					PlayerAnimations.IDLE.ordinal(), 1);
			idle.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.andou_stand), 1.0f,
					pressAndCollectVolume, basicVulnerabilityVolume));

			SpriteAnimation angle = new SpriteAnimation(
					PlayerAnimations.MOVE.ordinal(), 1);
			angle.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.andou_diag01), 0.0416f,
					pressAndCollectVolume, basicVulnerabilityVolume));

			SpriteAnimation extremeAngle = new SpriteAnimation(
					PlayerAnimations.MOVE_FAST.ordinal(), 1);
			extremeAngle.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.andou_diagmore01), 0.0416f,
					pressAndCollectVolume, basicVulnerabilityVolume));

			SpriteAnimation up = new SpriteAnimation(
					PlayerAnimations.BOOST_UP.ordinal(), 2);
			up.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.andou_flyup02), Utils
					.framesToTime(24, 1), pressAndCollectVolume,
					basicVulnerabilityVolume));
			up.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.andou_flyup03), Utils
					.framesToTime(24, 1), pressAndCollectVolume,
					basicVulnerabilityVolume));
			up.setLoop(true);

			SpriteAnimation boostAngle = new SpriteAnimation(
					PlayerAnimations.BOOST_MOVE.ordinal(), 2);
			boostAngle.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.andou_diag02), Utils
					.framesToTime(24, 1), pressAndCollectVolume,
					basicVulnerabilityVolume));
			boostAngle.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.andou_diag03), Utils
					.framesToTime(24, 1), pressAndCollectVolume,
					basicVulnerabilityVolume));
			...
			boostExtremeAngle.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.andou_diagmore02), Utils
					.framesToTime(24, 1), pressAndCollectVolume,
					basicVulnerabilityVolume));
			boostExtremeAngle.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.andou_diagmore03), Utils
					.framesToTime(24, 1), pressAndCollectVolume,
					basicVulnerabilityVolume));
			boostExtremeAngle.setLoop(true);

			FixedSizeArray<CollisionVolume> stompAttackVolume = new FixedSizeArray<CollisionVolume>(
					3);
			stompAttackVolume.add(new AABoxCollisionVolume(16, -5.0f, 32, 37,
					HitType.HIT));
			stompAttackVolume.add(pressCollisionVolume);
			stompAttackVolume.add(collectionVolume);

			SpriteAnimation stomp = new SpriteAnimation(
					PlayerAnimations.STOMP.ordinal(), 4);
			stomp.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.andou_stomp01), Utils
					.framesToTime(24, 1), stompAttackVolume, null));
			stomp.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.andou_stomp02), Utils
					.framesToTime(24, 1), stompAttackVolume, null));
			stomp.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.andou_stomp03), Utils
					.framesToTime(24, 1), stompAttackVolume, null));
			stomp.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.andou_stomp04), Utils
					.framesToTime(24, 1), stompAttackVolume, null));

			SpriteAnimation hitReactAnim = new SpriteAnimation(
					PlayerAnimations.HIT_REACT.ordinal(), 1);
			hitReactAnim.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.andou_hit), 0.1f,
					pressAndCollectVolume, null));

			SpriteAnimation deathAnim = new SpriteAnimation(
					PlayerAnimations.DEATH.ordinal(), 16);
			AnimationFrame death1 = new AnimationFrame(
					textureLibrary.allocateTexture(R.drawable.andou_die01),
					Utils.framesToTime(24, 1), null, null);
			AnimationFrame death2 = new AnimationFrame(
			...
			deathAnim.addFrame(death1);
			deathAnim.addFrame(death2);
			deathAnim.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.andou_explode01), Utils
					.framesToTime(24, 1), null, null));
			deathAnim.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.andou_explode02), Utils
					.framesToTime(24, 1), null, null));
			deathAnim.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.andou_explode03), Utils
					.framesToTime(24, 1), null, null));
			deathAnim.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.andou_explode04), Utils
					.framesToTime(24, 1), null, null));
			deathAnim.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.andou_explode05), Utils
					.framesToTime(24, 2), null, null));
			deathAnim.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.andou_explode06), Utils
					.framesToTime(24, 2), null, null));
			deathAnim.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.andou_explode07), Utils
					.framesToTime(24, 2), null, null));
			deathAnim.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.andou_explode08), Utils
					.framesToTime(24, 2), null, null));
			deathAnim.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.andou_explode09), Utils
					.framesToTime(24, 2), null, null));
			deathAnim.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.andou_explode10), Utils
					.framesToTime(24, 2), null, null));
			deathAnim.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.andou_explode11), Utils
					.framesToTime(24, 2), null, null));
			deathAnim.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.andou_explode12), Utils
					.framesToTime(24, 2), null, null));

			SpriteAnimation frozenAnim = new SpriteAnimation(
					PlayerAnimations.FROZEN.ordinal(), 1);
		...
		if (sound != null) {
			...
			animation.setRubySounds(sound.load(R.raw.gem1),
					sound.load(R.raw.gem2), sound.load(R.raw.gem3));
		...
		hitReact.setSpawnOnDealHit(HitType.HIT, GameObjectType.CRUSH_FLASH,
				false, true);
		...
		object.life = PlayerComponent.getDifficultyConstants()
				.getMaxPlayerLife();
		object.team = Team.PLAYER;

		// Very very basic DDA. Make the game easier if we've died on this level
		// too much.
		...
		// Jets
		{
			...
			if (jetStaticData == null) {
				...
				jetAnim.addFrame(new AnimationFrame(textureLibrary
						.allocateTexture(R.drawable.jetfire01), Utils
						.framesToTime(24, 1)));
				jetAnim.addFrame(new AnimationFrame(textureLibrary
						.allocateTexture(R.drawable.jetfire02), Utils
						.framesToTime(24, 1)));
		...
		// Sparks
		{
			...
			if (sparksStaticData == null) {
				...
				sparksAnim.addFrame(new AnimationFrame(textureLibrary
						.allocateTexture(R.drawable.spark01), Utils
						.framesToTime(24, 1)));
				sparksAnim.addFrame(new AnimationFrame(textureLibrary
						.allocateTexture(R.drawable.spark02), Utils
						.framesToTime(24, 1)));
				sparksAnim.addFrame(new AnimationFrame(textureLibrary
						.allocateTexture(R.drawable.spark03), Utils
						.framesToTime(24, 1)));
		...
		// Glow
		{
			...
			if (glowStaticData == null) {
				...
				FixedSizeArray<CollisionVolume> glowAttackVolume = new FixedSizeArray<CollisionVolume>(
						1);
				glowAttackVolume.add(new SphereCollisionVolume(40, 40, 40,
						HitType.HIT));

				SpriteAnimation glowAnim = new SpriteAnimation(0, 3);
				glowAnim.addFrame(new AnimationFrame(textureLibrary
						.allocateTexture(R.drawable.effect_glow01), Utils
						.framesToTime(24, 1), glowAttackVolume, null));
				glowAnim.addFrame(new AnimationFrame(textureLibrary
						.allocateTexture(R.drawable.effect_glow02), Utils
						.framesToTime(24, 1), glowAttackVolume, null));
				glowAnim.addFrame(new AnimationFrame(textureLibrary
						.allocateTexture(R.drawable.effect_glow03), Utils
						.framesToTime(24, 1), glowAttackVolume, null));
			...
			final float glowDuration = PlayerComponent.getDifficultyConstants()
					.getGlowDuration();
			glowFade.setupFade(1.0f, 0.0f, 0.15f,
					FadeDrawableComponent.LOOP_TYPE_PING_PONG,
					FadeDrawableComponent.FADE_EASE, glowDuration - 4.0f); // 4
																			// seconds
																			// before
																			// the
																			// glow
	...
	// Sparks are used by more than one enemy type, so the setup for them is
	// abstracted.
	...
	public GameObject spawnEnemyBrobot(float positionX, float positionY,
		...
		if (staticData == null) {
			...
			FixedSizeArray<CollisionVolume> basicAttackVolume = new FixedSizeArray<CollisionVolume>(
					2);
			basicAttackVolume.add(new SphereCollisionVolume(16, 32, 32,
					HitType.HIT));
			basicAttackVolume.add(new AABoxCollisionVolume(16, 0, 32, 16,
					HitType.DEPRESS));

			SpriteAnimation idle = new SpriteAnimation(
					EnemyAnimations.IDLE.ordinal(), 4);
			idle.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_brobot_idle01), Utils
					.framesToTime(24, 3), basicAttackVolume,
					basicVulnerabilityVolume));
			idle.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_brobot_idle02), Utils
					.framesToTime(24, 1), basicAttackVolume,
					basicVulnerabilityVolume));
			idle.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_brobot_idle03), Utils
					.framesToTime(24, 3), basicAttackVolume,
					basicVulnerabilityVolume));
			idle.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_brobot_idle02), Utils
			...
			SpriteAnimation walk = new SpriteAnimation(
					EnemyAnimations.MOVE.ordinal(), 3);
			walk.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_brobot_walk01), Utils
					.framesToTime(24, 1), basicAttackVolume,
					basicVulnerabilityVolume));
			walk.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_brobot_walk02), Utils
					.framesToTime(24, 1), basicAttackVolume,
					basicVulnerabilityVolume));
			walk.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_brobot_walk03), Utils
					.framesToTime(24, 1), basicAttackVolume,
					basicVulnerabilityVolume));
			walk.setLoop(true);
		...
		SimplePhysicsComponent normalPhysics = object
				.findByClass(SimplePhysicsComponent.class);
	...
	public GameObject spawnEnemySnailBomb(float positionX, float positionY,
			boolean flipHorizontal) {
		...
		if (staticData == null) {
			...
			FixedSizeArray<CollisionVolume> basicVulnerabilityVolume = new FixedSizeArray<CollisionVolume>(
					1);
			basicVulnerabilityVolume.add(new AABoxCollisionVolume(12, 5, 42,
					27, HitType.HIT));

			FixedSizeArray<CollisionVolume> basicAttackVolume = new FixedSizeArray<CollisionVolume>(
					1);
			basicAttackVolume.add(new AABoxCollisionVolume(12, 5, 42, 27,
					HitType.HIT));

			SpriteAnimation idle = new SpriteAnimation(
					EnemyAnimations.IDLE.ordinal(), 1);
			idle.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.snailbomb_stand), Utils
					.framesToTime(24, 3), basicAttackVolume,
					basicVulnerabilityVolume));

			SpriteAnimation walk = new SpriteAnimation(
					EnemyAnimations.MOVE.ordinal(), 5);
			walk.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.snailbomb_stand), Utils
					.framesToTime(24, 2), basicAttackVolume,
					basicVulnerabilityVolume));
			walk.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.snailbomb_walk01), Utils
					.framesToTime(24, 2), basicAttackVolume,
					basicVulnerabilityVolume));
			walk.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.snailbomb_walk02), Utils
					.framesToTime(24, 6), basicAttackVolume,
					basicVulnerabilityVolume));
			walk.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.snailbomb_walk01), Utils
					.framesToTime(24, 2), basicAttackVolume,
			...
			SpriteAnimation attack = new SpriteAnimation(
					EnemyAnimations.ATTACK.ordinal(), 2);
			attack.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.snailbomb_shoot01), Utils
					.framesToTime(24, 3), basicAttackVolume,
					basicVulnerabilityVolume));
			attack.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.snailbomb_shoot02), Utils
					.framesToTime(24, 2), basicAttackVolume,
					basicVulnerabilityVolume));
		...
		final SpriteAnimation attack = sprite
				.findAnimation(EnemyAnimations.ATTACK.ordinal());
		if (attack != null) {
	...
	public GameObject spawnEnemyShadowSlime(float positionX, float positionY,
			boolean flipHorizontal) {
		...
		if (staticData == null) {
			...
			// edit: these guys turned out to be really annoying, so I'm
			// changing the values
			...
			SpriteAnimation idle = new SpriteAnimation(
					EnemyAnimations.IDLE.ordinal(), 2);
			AnimationFrame idle1 = new AnimationFrame(
					textureLibrary
							.allocateTexture(R.drawable.enemy_shadowslime_idle01),
					Utils.framesToTime(24, 3), basicAttackVolume,
					basicVulnerabilityVolume);
			AnimationFrame idle2 = new AnimationFrame(
					textureLibrary
							.allocateTexture(R.drawable.enemy_shadowslime_idle02),
					Utils.framesToTime(24, 3), basicAttackVolume,
					basicVulnerabilityVolume);
			idle.addFrame(idle1);
			idle.addFrame(idle2);
			...
			SpriteAnimation appear = new SpriteAnimation(
					EnemyAnimations.APPEAR.ordinal(), 6);
			AnimationFrame appear1 = new AnimationFrame(
					textureLibrary
							.allocateTexture(R.drawable.enemy_shadowslime_activate01),
					Utils.framesToTime(24, 2), basicAttackVolume,
					basicVulnerabilityVolume);

			AnimationFrame appear2 = new AnimationFrame(
					textureLibrary
							.allocateTexture(R.drawable.enemy_shadowslime_activate02),
					Utils.framesToTime(24, 2), basicAttackVolume,
					basicVulnerabilityVolume);
			AnimationFrame appear3 = new AnimationFrame(
					textureLibrary
							.allocateTexture(R.drawable.enemy_shadowslime_activate03),
					Utils.framesToTime(24, 1), basicAttackVolume,
					basicVulnerabilityVolume);
			AnimationFrame appear4 = new AnimationFrame(
					textureLibrary
							.allocateTexture(R.drawable.enemy_shadowslime_activate04),
					Utils.framesToTime(24, 1), basicAttackVolume,
					basicVulnerabilityVolume);
			AnimationFrame appear5 = new AnimationFrame(
					textureLibrary
							.allocateTexture(R.drawable.enemy_shadowslime_activate05),
					Utils.framesToTime(24, 2), basicAttackVolume,
					basicVulnerabilityVolume);
			AnimationFrame appear6 = new AnimationFrame(
					textureLibrary
							.allocateTexture(R.drawable.enemy_shadowslime_activate06),
					Utils.framesToTime(24, 1), basicAttackVolume,
					basicVulnerabilityVolume);
			...
			SpriteAnimation hidden = new SpriteAnimation(
					EnemyAnimations.HIDDEN.ordinal(), 6);
			 ...
			 * (R.drawable.enemy_shadowslime_stand), Utils.framesToTime(24, 3),
			 * basicAttackVolume, basicVulnerabilityVolume));
			 */

			SpriteAnimation attack = new SpriteAnimation(
					EnemyAnimations.ATTACK.ordinal(), 10);
			AnimationFrame attack1 = new AnimationFrame(
					textureLibrary
							.allocateTexture(R.drawable.enemy_shadowslime_attack01),
					Utils.framesToTime(24, 2), basicAttackVolume,
					basicVulnerabilityVolume);
			AnimationFrame attack2 = new AnimationFrame(
					textureLibrary
							.allocateTexture(R.drawable.enemy_shadowslime_attack02),
					Utils.framesToTime(24, 2), basicAttackVolume,
					basicVulnerabilityVolume);
			AnimationFrame attack3 = new AnimationFrame(
					textureLibrary
							.allocateTexture(R.drawable.enemy_shadowslime_attack03),
					Utils.framesToTime(24, 2), basicAttackVolume,
					basicVulnerabilityVolume);
			AnimationFrame attack4 = new AnimationFrame(
					textureLibrary
							.allocateTexture(R.drawable.enemy_shadowslime_attack04),
					Utils.framesToTime(24, 6), basicAttackVolume,
					basicVulnerabilityVolume);
			AnimationFrame attackFlash = new AnimationFrame(
					textureLibrary
							.allocateTexture(R.drawable.enemy_shadowslime_flash),
					Utils.framesToTime(24, 1), basicAttackVolume,
					basicVulnerabilityVolume);
		...
		final SpriteAnimation attack = sprite
				.findAnimation(EnemyAnimations.ATTACK.ordinal());
		final SpriteAnimation appear = sprite
				.findAnimation(EnemyAnimations.APPEAR.ordinal());
	...
	public GameObject spawnEnemyMudman(float positionX, float positionY,
			boolean flipHorizontal) {
		TextureLibrary textureLibrary = sSystemRegistry.shortTermTextureLibrary;
		...
		if (staticData == null) {
			...
			SpriteAnimation idle = new SpriteAnimation(
					EnemyAnimations.IDLE.ordinal(), 4);
			idle.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_mud_stand), Utils
					.framesToTime(24, 12), null, null));
			AnimationFrame idle1 = new AnimationFrame(
			...
			SpriteAnimation walk = new SpriteAnimation(
					EnemyAnimations.MOVE.ordinal(), 6);
			walk.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_mud_walk01), Utils
					.framesToTime(24, 4), null, null));
			walk.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_mud_walk02), Utils
					.framesToTime(24, 4), null, null));
			walk.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_mud_walk03), Utils
					.framesToTime(24, 5), null, null));
			walk.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_mud_walk04), Utils
					.framesToTime(24, 4), null, null));
			walk.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_mud_walk05), Utils
					.framesToTime(24, 4), null, null));
			walk.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_mud_walk06), Utils
					.framesToTime(24, 5), null, null));
			walk.setLoop(true);

			FixedSizeArray<CollisionVolume> crushAttackVolume = new FixedSizeArray<CollisionVolume>(
					1);
			crushAttackVolume.add(new AABoxCollisionVolume(64, 0, 64, 96,
					HitType.HIT));

			SpriteAnimation attack = new SpriteAnimation(
					EnemyAnimations.ATTACK.ordinal(), 8);
			attack.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_mud_stand), Utils
					.framesToTime(24, 2), null, null));
			attack.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_mud_attack01), Utils
					.framesToTime(24, 2), null, null));
			attack.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_mud_attack02), Utils
					.framesToTime(24, 2), null, null));
			attack.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_mud_attack03), Utils
					.framesToTime(24, 2), null, null));
			attack.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_mud_attack04), Utils
					.framesToTime(24, 1), crushAttackVolume, null));
			attack.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_mud_attack05), Utils
					.framesToTime(24, 1), crushAttackVolume, null));
			attack.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_mud_attack06), Utils
					.framesToTime(24, 8), crushAttackVolume, null));
			attack.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_mud_attack07), Utils
					.framesToTime(24, 5), null, null));
	...
	public GameObject spawnEnemySkeleton(float positionX, float positionY,
			boolean flipHorizontal) {
		TextureLibrary textureLibrary = sSystemRegistry.shortTermTextureLibrary;
		...
		if (staticData == null) {
			...
			FixedSizeArray<CollisionVolume> basicAttackVolume = new FixedSizeArray<CollisionVolume>(
					1);
			basicAttackVolume.add(new SphereCollisionVolume(16, 48, 32,
					HitType.HIT));

			SpriteAnimation idle = new SpriteAnimation(
					EnemyAnimations.IDLE.ordinal(), 1);
			idle.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_skeleton_stand), Utils
					.framesToTime(24, 1), null, basicVulnerabilityVolume));

			SpriteAnimation walk = new SpriteAnimation(
					EnemyAnimations.MOVE.ordinal(), 6);
			walk.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_skeleton_walk01), Utils
					.framesToTime(24, 3), null, basicVulnerabilityVolume));
			walk.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_skeleton_walk02), Utils
					.framesToTime(24, 4), null, basicVulnerabilityVolume));
			walk.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_skeleton_walk03), Utils
					.framesToTime(24, 3), null, basicVulnerabilityVolume));
			walk.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_skeleton_walk04), Utils
					.framesToTime(24, 3), null, basicVulnerabilityVolume));
			walk.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_skeleton_walk05), Utils
					.framesToTime(24, 4), null, basicVulnerabilityVolume));
			walk.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_skeleton_walk03), Utils
					.framesToTime(24, 3), null, basicVulnerabilityVolume));
			...
			SpriteAnimation attack = new SpriteAnimation(
					EnemyAnimations.ATTACK.ordinal(), 3);
			attack.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_skeleton_attack01), Utils
					.framesToTime(24, 5), null, basicVulnerabilityVolume));
			attack.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_skeleton_attack03), Utils
					.framesToTime(24, 1), basicAttackVolume,
					basicVulnerabilityVolume));
			attack.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_skeleton_attack04), Utils
					.framesToTime(24, 1), basicAttackVolume,
					basicVulnerabilityVolume));
	...
	public GameObject spawnEnemyKaraguin(float positionX, float positionY,
			boolean flipHorizontal) {
		TextureLibrary textureLibrary = sSystemRegistry.shortTermTextureLibrary;
		...
		if (staticData == null) {
			...
			FixedSizeArray<CollisionVolume> basicAttackVolume = new FixedSizeArray<CollisionVolume>(
					1);
			basicAttackVolume.add(new SphereCollisionVolume(8, 16, 16,
					HitType.HIT));

			SpriteAnimation idle = new SpriteAnimation(0, 3);
			idle.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_karaguin01), Utils
					.framesToTime(24, 1), basicAttackVolume,
					basicVulnerabilityVolume));
			idle.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_karaguin02), Utils
					.framesToTime(24, 1), basicAttackVolume,
					basicVulnerabilityVolume));
			idle.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_karaguin03), Utils
					.framesToTime(24, 1), basicAttackVolume,
					basicVulnerabilityVolume));
			idle.setLoop(true);
		...
		// HACK. These guys originally moved on their own, so let's keep them
		// that way.
	...
	public GameObject spawnEnemyPinkNamazu(float positionX, float positionY,
			boolean flipHorizontal) {
		TextureLibrary textureLibrary = sSystemRegistry.shortTermTextureLibrary;
		...
		if (staticData == null) {
			...
			Vector2 surface1Normal = new Vector2(-0.98058067569092f,
					-0.19611613513818f);
			surface1Normal.normalize();

			Vector2 surface2Start = new Vector2(22, 52);
			Vector2 surface2End = new Vector2(50, 75);
			Vector2 surface2Normal = new Vector2(-0.62580046626293f,
					0.77998318983495f);
			surface2Normal.normalize();
			...
			Vector2 surface4Normal = new Vector2(0.74038072228541f,
					0.67218776102228f);
			...
			SpriteAnimation idle = new SpriteAnimation(
					GenericAnimationComponent.Animation.IDLE, 4);
			idle.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_pinkdude_stand), Utils
					.framesToTime(24, 8), null, null));
			AnimationFrame idle1 = new AnimationFrame(
					textureLibrary
							.allocateTexture(R.drawable.enemy_pinkdude_sleep01),
					Utils.framesToTime(24, 3), null, null);
			AnimationFrame idle2 = new AnimationFrame(
					textureLibrary
							.allocateTexture(R.drawable.enemy_pinkdude_sleep02),
			...
			SpriteAnimation wake = new SpriteAnimation(
					GenericAnimationComponent.Animation.MOVE, 4);
			AnimationFrame wake1 = new AnimationFrame(
					textureLibrary
							.allocateTexture(R.drawable.enemy_pinkdude_eyeopen),
					Utils.framesToTime(24, 3), null, null);
			AnimationFrame wake2 = new AnimationFrame(
					textureLibrary
							.allocateTexture(R.drawable.enemy_pinkdude_stand),
					Utils.framesToTime(24, 3), null, null);
			wake.addFrame(wake1);
			wake.addFrame(wake2);
			wake.addFrame(wake1);
			...
			FixedSizeArray<CollisionVolume> crushAttackVolume = new FixedSizeArray<CollisionVolume>(
					1);
			crushAttackVolume.add(new AABoxCollisionVolume(32, 0, 64, 32,
					HitType.HIT));

			SpriteAnimation attack = new SpriteAnimation(
					GenericAnimationComponent.Animation.ATTACK, 1);
			attack.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_pinkdude_jump), Utils
					.framesToTime(24, 2), crushAttackVolume, null));
		...
		final SpriteAnimation wakeUp = sprite
				.findAnimation(GenericAnimationComponent.Animation.MOVE);
		if (wakeUp != null) {
	...
	public GameObject spawnEnemyBat(float positionX, float positionY,
			boolean flipHorizontal) {
		TextureLibrary textureLibrary = sSystemRegistry.shortTermTextureLibrary;
		...
		if (staticData == null) {
			...
			FixedSizeArray<CollisionVolume> basicAttackVolume = new FixedSizeArray<CollisionVolume>(
					1);
			basicAttackVolume.add(new SphereCollisionVolume(16, 32, 16,
					HitType.HIT));

			SpriteAnimation idle = new SpriteAnimation(0, 4);
			idle.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_bat01), Utils
					.framesToTime(24, 1), basicAttackVolume,
					basicVulnerabilityVolume));
			idle.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_bat02), Utils
					.framesToTime(24, 1), basicAttackVolume,
					basicVulnerabilityVolume));
			idle.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_bat03), Utils
					.framesToTime(24, 1), basicAttackVolume,
					basicVulnerabilityVolume));
			idle.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_bat04), Utils
					.framesToTime(24, 1), basicAttackVolume,
					basicVulnerabilityVolume));
			idle.setLoop(true);
	...
	public GameObject spawnEnemySting(float positionX, float positionY,
			boolean flipHorizontal) {
		TextureLibrary textureLibrary = sSystemRegistry.shortTermTextureLibrary;
		...
		if (staticData == null) {
			...
			SpriteAnimation idle = new SpriteAnimation(0, 3);
			idle.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_sting01), Utils
					.framesToTime(24, 1), basicAttackVolume,
					basicVulnerabilityVolume));
			idle.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_sting02), Utils
					.framesToTime(24, 1), basicAttackVolume,
					basicVulnerabilityVolume));
			idle.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_sting03), Utils
					.framesToTime(24, 1), basicAttackVolume,
					basicVulnerabilityVolume));
	...
	public GameObject spawnEnemyOnion(float positionX, float positionY,
			boolean flipHorizontal) {
		TextureLibrary textureLibrary = sSystemRegistry.shortTermTextureLibrary;
		...
		if (staticData == null) {
			...
			SpriteAnimation idle = new SpriteAnimation(
					EnemyAnimations.IDLE.ordinal(), 1);
			idle.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_onion01), Utils
					.framesToTime(24, 3), basicAttackVolume,
					basicVulnerabilityVolume));
			...
			walk.addFrame(new AnimationFrame(textureLibrary
					...
					basicVulnerabilityVolume));
			walk.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_onion02), Utils
					.framesToTime(24, 1), basicAttackVolume,
					basicVulnerabilityVolume));
			walk.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_onion03), Utils
					.framesToTime(24, 1), basicAttackVolume,
					basicVulnerabilityVolume));
			walk.setLoop(true);
	...
	public GameObject spawnEnemyWanda(float positionX, float positionY,
			boolean flipHorizontal) {
		TextureLibrary textureLibrary = sSystemRegistry.shortTermTextureLibrary;
		...
		if (staticData == null) {
			...
			FixedSizeArray<CollisionVolume> basicVulnerabilityVolume = new FixedSizeArray<CollisionVolume>(
					1);
			basicVulnerabilityVolume.add(new AABoxCollisionVolume(20, 5, 26,
					80, HitType.COLLECT));

			SpriteAnimation idle = new SpriteAnimation(
					NPCAnimationComponent.IDLE, 1);
			idle.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_wanda_stand), Utils
					.framesToTime(24, 1), null, basicVulnerabilityVolume));

			AnimationFrame walkFrame1 = new AnimationFrame(
					textureLibrary
							.allocateTexture(R.drawable.enemy_wanda_walk01),
					Utils.framesToTime(24, 2), null, basicVulnerabilityVolume);
			AnimationFrame walkFrame2 = new AnimationFrame(
					textureLibrary
							.allocateTexture(R.drawable.enemy_wanda_walk02),
					Utils.framesToTime(24, 2), null, basicVulnerabilityVolume);
			AnimationFrame walkFrame3 = new AnimationFrame(
					textureLibrary
							.allocateTexture(R.drawable.enemy_wanda_walk03),
					Utils.framesToTime(24, 2), null, basicVulnerabilityVolume);
			AnimationFrame walkFrame4 = new AnimationFrame(
					textureLibrary
							.allocateTexture(R.drawable.enemy_wanda_walk04),
					Utils.framesToTime(24, 2), null, basicVulnerabilityVolume);
			AnimationFrame walkFrame5 = new AnimationFrame(
					textureLibrary
							.allocateTexture(R.drawable.enemy_wanda_walk05),
					Utils.framesToTime(24, 2), null, basicVulnerabilityVolume);
			SpriteAnimation walk = new SpriteAnimation(
					NPCAnimationComponent.WALK, 8);
			...
			AnimationFrame runFrame4 = new AnimationFrame(
					textureLibrary
							.allocateTexture(R.drawable.enemy_wanda_run04),
					Utils.framesToTime(24, 1), null, basicVulnerabilityVolume);

			SpriteAnimation run = new SpriteAnimation(
					NPCAnimationComponent.RUN, 9);
			run.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_wanda_run01), Utils
					.framesToTime(24, 1), null, basicVulnerabilityVolume));
			run.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_wanda_run02), Utils
					.framesToTime(24, 1), null, basicVulnerabilityVolume));
			run.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_wanda_run03), Utils
					.framesToTime(24, 1), null, basicVulnerabilityVolume));
			run.addFrame(runFrame4);
			run.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_wanda_run05), Utils
					.framesToTime(24, 1), null, basicVulnerabilityVolume));
			run.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_wanda_run06), Utils
					.framesToTime(24, 1), null, basicVulnerabilityVolume));
			run.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_wanda_run07), Utils
					.framesToTime(24, 1), null, basicVulnerabilityVolume));
			run.addFrame(runFrame4);
			run.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_wanda_run08), Utils
					.framesToTime(24, 1), null, basicVulnerabilityVolume));
			run.setLoop(true);

			SpriteAnimation jumpStart = new SpriteAnimation(
					NPCAnimationComponent.JUMP_START, 4);
			AnimationFrame jump1 = new AnimationFrame(
					textureLibrary
							.allocateTexture(R.drawable.enemy_wanda_jump01),
					Utils.framesToTime(24, 1), null, basicVulnerabilityVolume);
			AnimationFrame jump2 = new AnimationFrame(
					textureLibrary
							.allocateTexture(R.drawable.enemy_wanda_jump01),
					Utils.framesToTime(24, 1), null, basicVulnerabilityVolume);
			jumpStart.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_wanda_run04), Utils
					.framesToTime(24, 2), null, basicVulnerabilityVolume));
			jumpStart.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_wanda_crouch), Utils
					.framesToTime(24, 1), null, basicVulnerabilityVolume));
			jumpStart.addFrame(jump1);
			jumpStart.addFrame(jump2);

			SpriteAnimation jumpAir = new SpriteAnimation(
					NPCAnimationComponent.JUMP_AIR, 2);
			jumpAir.addFrame(jump1);
			jumpAir.addFrame(jump2);
			jumpAir.setLoop(true);

			SpriteAnimation attack = new SpriteAnimation(
					NPCAnimationComponent.SHOOT, 11);
			attack.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_wanda_shoot01), Utils
					.framesToTime(24, 2), null, basicVulnerabilityVolume));
			attack.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_wanda_shoot02), Utils
					.framesToTime(24, 8), null, basicVulnerabilityVolume));
			attack.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_wanda_shoot03), Utils
					.framesToTime(24, 1), null, basicVulnerabilityVolume));
			attack.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_wanda_shoot04), Utils
					.framesToTime(24, 1), null, basicVulnerabilityVolume));
			attack.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_wanda_shoot05), Utils
					.framesToTime(24, 1), null, basicVulnerabilityVolume));
			attack.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_wanda_shoot06), Utils
					.framesToTime(24, 1), null, basicVulnerabilityVolume));
			attack.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_wanda_shoot07), Utils
					.framesToTime(24, 1), null, basicVulnerabilityVolume));
			attack.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_wanda_shoot08), Utils
					.framesToTime(24, 1), null, basicVulnerabilityVolume));
			attack.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_wanda_shoot09), Utils
					.framesToTime(24, 2), null, basicVulnerabilityVolume));
			attack.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_wanda_shoot02), Utils
					.framesToTime(24, 3), null, basicVulnerabilityVolume));
	...
	public GameObject spawnEnemyKyle(float positionX, float positionY,
			boolean flipHorizontal) {
		TextureLibrary textureLibrary = sSystemRegistry.shortTermTextureLibrary;
		...
		if (staticData == null) {
			...
			SpriteAnimation idle = new SpriteAnimation(
					NPCAnimationComponent.IDLE, 1);
			idle.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_kyle_stand), Utils
					.framesToTime(24, 1), null, basicVulnerabilityVolume));

			AnimationFrame walkFrame1 = new AnimationFrame(
					textureLibrary
							.allocateTexture(R.drawable.enemy_kyle_walk01),
					Utils.framesToTime(24, 2), null, basicVulnerabilityVolume);
			AnimationFrame walkFrame2 = new AnimationFrame(
					textureLibrary
							.allocateTexture(R.drawable.enemy_kyle_walk02),
					Utils.framesToTime(24, 2), null, basicVulnerabilityVolume);
			AnimationFrame walkFrame3 = new AnimationFrame(
					textureLibrary
							.allocateTexture(R.drawable.enemy_kyle_walk03),
					Utils.framesToTime(24, 2), null, basicVulnerabilityVolume);
			AnimationFrame walkFrame4 = new AnimationFrame(
					textureLibrary
							.allocateTexture(R.drawable.enemy_kyle_walk04),
					Utils.framesToTime(24, 2), null, basicVulnerabilityVolume);
			AnimationFrame walkFrame5 = new AnimationFrame(
					textureLibrary
							.allocateTexture(R.drawable.enemy_kyle_walk05),
					Utils.framesToTime(24, 2), null, basicVulnerabilityVolume);
			AnimationFrame walkFrame6 = new AnimationFrame(
					textureLibrary
							.allocateTexture(R.drawable.enemy_kyle_walk06),
					Utils.framesToTime(24, 2), null, basicVulnerabilityVolume);
			AnimationFrame walkFrame7 = new AnimationFrame(
					textureLibrary
							.allocateTexture(R.drawable.enemy_kyle_walk07),
					Utils.framesToTime(24, 2), null, basicVulnerabilityVolume);
			SpriteAnimation walk = new SpriteAnimation(
					NPCAnimationComponent.WALK, 12);
			walk.addFrame(walkFrame1);
			walk.addFrame(walkFrame2);
			walk.addFrame(walkFrame3);
			walk.addFrame(walkFrame4);
			...
			AnimationFrame crouch1 = new AnimationFrame(
					textureLibrary
							.allocateTexture(R.drawable.enemy_kyle_crouch01),
					Utils.framesToTime(24, 1), null, basicVulnerabilityVolume);
			AnimationFrame crouch2 = new AnimationFrame(
					textureLibrary
							.allocateTexture(R.drawable.enemy_kyle_crouch02),
					Utils.framesToTime(24, 3), null, basicVulnerabilityVolume);

			SpriteAnimation runStart = new SpriteAnimation(
					NPCAnimationComponent.RUN_START, 2);
			runStart.addFrame(crouch1);
			runStart.addFrame(crouch2);

			FixedSizeArray<CollisionVolume> attackVolume = new FixedSizeArray<CollisionVolume>(
					2);
			attackVolume.add(new AABoxCollisionVolume(32, 32, 50, 32,
					HitType.HIT));
			attackVolume.add(new AABoxCollisionVolume(32, 32, 50, 32,
					HitType.COLLECT));

			SpriteAnimation run = new SpriteAnimation(
					NPCAnimationComponent.RUN, 2);
			run.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_kyle_dash01), Utils
					.framesToTime(24, 1), attackVolume,
					basicVulnerabilityVolume));
			run.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_kyle_dash02), Utils
					.framesToTime(24, 1), attackVolume,
					basicVulnerabilityVolume));
			run.setLoop(true);

			SpriteAnimation jumpStart = new SpriteAnimation(
					NPCAnimationComponent.JUMP_START, 2);
			...
			AnimationFrame jump1 = new AnimationFrame(
					textureLibrary
							.allocateTexture(R.drawable.enemy_kyle_jump01),
					Utils.framesToTime(24, 1), null, basicVulnerabilityVolume);
			AnimationFrame jump2 = new AnimationFrame(
					textureLibrary
							.allocateTexture(R.drawable.enemy_kyle_jump01),
		...
		patrol.setGameEvent(GameFlowEvent.EVENT_SHOW_ANIMATION,
				AnimationPlayerActivity.KYLE_DEATH, false);
	...
	public GameObject spawnEnemyKyleDead(float positionX, float positionY) {
		...
		if (staticData == null) {
			...
			FixedSizeArray<CollisionVolume> basicVulnerabilityVolume = new FixedSizeArray<CollisionVolume>(
					1);
			basicVulnerabilityVolume.add(new AABoxCollisionVolume(32, 5, 64,
					32, HitType.COLLECT));
		...
		hitReact.setSpawnGameEventOnHit(HitType.COLLECT,
				GameFlowEvent.EVENT_SHOW_DIALOG_CHARACTER2, 0);
		...
		// Since this object doesn't have gravity or background collision,
		// adjust down to simulate the position
	...
	public GameObject spawnEnemyKabocha(float positionX, float positionY,
			boolean flipHorizontal) {
		TextureLibrary textureLibrary = sSystemRegistry.shortTermTextureLibrary;
		...
		if (staticData == null) {
			...
			SpriteAnimation idle = new SpriteAnimation(
					NPCAnimationComponent.IDLE, 1);
			idle.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_kabocha_stand), Utils
					.framesToTime(24, 1), null, basicVulnerabilityVolume));

			AnimationFrame walkFrame1 = new AnimationFrame(
					textureLibrary
							.allocateTexture(R.drawable.enemy_kabocha_walk01),
					Utils.framesToTime(24, 3), null, basicVulnerabilityVolume);
			AnimationFrame walkFrame2 = new AnimationFrame(
					textureLibrary
							.allocateTexture(R.drawable.enemy_kabocha_walk02),
					Utils.framesToTime(24, 3), null, basicVulnerabilityVolume);
			AnimationFrame walkFrame3 = new AnimationFrame(
					textureLibrary
							.allocateTexture(R.drawable.enemy_kabocha_walk03),
					Utils.framesToTime(24, 3), null, basicVulnerabilityVolume);
			AnimationFrame walkFrame4 = new AnimationFrame(
					textureLibrary
							.allocateTexture(R.drawable.enemy_kabocha_walk04),
					Utils.framesToTime(24, 3), null, basicVulnerabilityVolume);
			AnimationFrame walkFrame5 = new AnimationFrame(
					textureLibrary
							.allocateTexture(R.drawable.enemy_kabocha_walk05),
					Utils.framesToTime(24, 3), null, basicVulnerabilityVolume);
			AnimationFrame walkFrame6 = new AnimationFrame(
					textureLibrary
							.allocateTexture(R.drawable.enemy_kabocha_walk06),
					Utils.framesToTime(24, 3), null, basicVulnerabilityVolume);

			SpriteAnimation walk = new SpriteAnimation(
					NPCAnimationComponent.WALK, 6);
			walk.addFrame(walkFrame1);
			walk.addFrame(walkFrame2);
			walk.addFrame(walkFrame3);
			walk.addFrame(walkFrame4);
	...
	public GameObject spawnRokudouTerminal(float positionX, float positionY) {
		...
		if (staticData == null) {
			...
			FixedSizeArray<CollisionVolume> basicVulnerabilityVolume = new FixedSizeArray<CollisionVolume>(
					1);
			basicVulnerabilityVolume
					.add(new AABoxCollisionVolume(0, 0, 64, 64));
			basicVulnerabilityVolume.get(0).setHitType(HitType.COLLECT);

			AnimationFrame frame1 = new AnimationFrame(
					textureLibrary
							.allocateTexture(R.drawable.object_terminal01),
					Utils.framesToTime(24, 1), null, basicVulnerabilityVolume);
			AnimationFrame frame2 = new AnimationFrame(
					textureLibrary
							.allocateTexture(R.drawable.object_terminal02),
					Utils.framesToTime(24, 1), null, basicVulnerabilityVolume);
			AnimationFrame frame3 = new AnimationFrame(
					textureLibrary
							.allocateTexture(R.drawable.object_terminal03),
					Utils.framesToTime(24, 1), null, basicVulnerabilityVolume);
	...
	public GameObject spawnKabochaTerminal(float positionX, float positionY) {
		...
		if (staticData == null) {
			...
			AnimationFrame frame1 = new AnimationFrame(
					textureLibrary
							.allocateTexture(R.drawable.object_terminal_kabocha01),
					Utils.framesToTime(24, 1), null, basicVulnerabilityVolume);
			AnimationFrame frame2 = new AnimationFrame(
					textureLibrary
							.allocateTexture(R.drawable.object_terminal_kabocha02),
					Utils.framesToTime(24, 1), null, basicVulnerabilityVolume);
			AnimationFrame frame3 = new AnimationFrame(
					textureLibrary
							.allocateTexture(R.drawable.object_terminal_kabocha03),
					Utils.framesToTime(24, 1), null, basicVulnerabilityVolume);
			AnimationFrame frame4 = new AnimationFrame(
					textureLibrary
							.allocateTexture(R.drawable.object_terminal_kabocha01),
	...
	public GameObject spawnEnemyEvilKabocha(float positionX, float positionY,
			boolean flipHorizontal) {
		TextureLibrary textureLibrary = sSystemRegistry.shortTermTextureLibrary;
		...
		if (staticData == null) {
			...
			FixedSizeArray<CollisionVolume> basicVulnerabilityVolume = new FixedSizeArray<CollisionVolume>(
					1);
			basicVulnerabilityVolume.add(new AABoxCollisionVolume(52, 5, 26,
					80, HitType.HIT));

			SpriteAnimation idle = new SpriteAnimation(
					NPCAnimationComponent.IDLE, 1);
			idle.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_kabocha_evil_stand),
					Utils.framesToTime(24, 1), null, basicVulnerabilityVolume));

			AnimationFrame walkFrame1 = new AnimationFrame(
					textureLibrary
							.allocateTexture(R.drawable.enemy_kabocha_evil_walk01),
					Utils.framesToTime(24, 3), null, basicVulnerabilityVolume);
			AnimationFrame walkFrame2 = new AnimationFrame(
					textureLibrary
							.allocateTexture(R.drawable.enemy_kabocha_evil_walk02),
					Utils.framesToTime(24, 3), null, basicVulnerabilityVolume);
			AnimationFrame walkFrame3 = new AnimationFrame(
					textureLibrary
							.allocateTexture(R.drawable.enemy_kabocha_evil_walk03),
					Utils.framesToTime(24, 3), null, basicVulnerabilityVolume);
			AnimationFrame walkFrame4 = new AnimationFrame(
					textureLibrary
							.allocateTexture(R.drawable.enemy_kabocha_evil_walk04),
					Utils.framesToTime(24, 3), null, basicVulnerabilityVolume);
			AnimationFrame walkFrame5 = new AnimationFrame(
					textureLibrary
							.allocateTexture(R.drawable.enemy_kabocha_evil_walk05),
					Utils.framesToTime(24, 3), null, basicVulnerabilityVolume);
			AnimationFrame walkFrame6 = new AnimationFrame(
					textureLibrary
							.allocateTexture(R.drawable.enemy_kabocha_evil_walk06),
					Utils.framesToTime(24, 3), null, basicVulnerabilityVolume);
			...
			SpriteAnimation surprised = new SpriteAnimation(
					NPCAnimationComponent.SURPRISED, 1);
			surprised.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_kabocha_evil_surprised),
					4.0f, null, null));

			SpriteAnimation hit = new SpriteAnimation(
					NPCAnimationComponent.TAKE_HIT, 2);
			hit.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_kabocha_evil_hit01),
					Utils.framesToTime(24, 1), null, null));
			hit.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_kabocha_evil_hit02),
					Utils.framesToTime(24, 10), null, null));

			SpriteAnimation die = new SpriteAnimation(
					NPCAnimationComponent.DEATH, 5);
			die.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_kabocha_evil_die01),
					Utils.framesToTime(24, 6), null, null));
			die.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_kabocha_evil_stand),
					Utils.framesToTime(24, 2), null, null));
			die.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_kabocha_evil_die02),
					Utils.framesToTime(24, 2), null, null));
			die.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_kabocha_evil_die03),
					Utils.framesToTime(24, 2), null, null));
			die.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_kabocha_evil_die04),
					Utils.framesToTime(24, 6), null, null));
		...
		patrol.setGameEvent(GameFlowEvent.EVENT_SHOW_ANIMATION,
				AnimationPlayerActivity.ROKUDOU_ENDING, true);
		...
		SoundSystem sound = sSystemRegistry.soundSystem;
		if (sound != null) {
			hitReact.setTakeHitSound(HitType.HIT,
					sound.load(R.raw.sound_kabocha_hit));
		}
	...
	public GameObject spawnEnemyRokudou(float positionX, float positionY,
			boolean flipHorizontal) {
		TextureLibrary textureLibrary = sSystemRegistry.shortTermTextureLibrary;
		...
		if (staticData == null) {
			...
			FixedSizeArray<CollisionVolume> basicVulnerabilityVolume = new FixedSizeArray<CollisionVolume>(
					1);
			basicVulnerabilityVolume.add(new AABoxCollisionVolume(45, 23, 42,
					75, HitType.HIT));

			SpriteAnimation idle = new SpriteAnimation(
					NPCAnimationComponent.IDLE, 1);
			idle.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_rokudou_fight_stand),
					Utils.framesToTime(24, 1), null, basicVulnerabilityVolume));

			SpriteAnimation fly = new SpriteAnimation(
					NPCAnimationComponent.WALK, 2);
			fly.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_rokudou_fight_fly01),
					1.0f, null, basicVulnerabilityVolume));
			fly.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_rokudou_fight_fly02),
					1.0f, null, basicVulnerabilityVolume));
			fly.setLoop(true);

			SpriteAnimation shoot = new SpriteAnimation(
					NPCAnimationComponent.SHOOT, 2);
			shoot.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_rokudou_fight_shoot01),
					Utils.framesToTime(24, 2), null, basicVulnerabilityVolume));
			shoot.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_rokudou_fight_shoot02),
					Utils.framesToTime(24, 2), null, basicVulnerabilityVolume));
			shoot.setLoop(true);
			...
			SpriteAnimation surprised = new SpriteAnimation(
					NPCAnimationComponent.SURPRISED, 1);
			surprised.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_rokudou_fight_surprise),
					4.0f, null, null));
			...
			AnimationFrame hitFrame1 = new AnimationFrame(
					textureLibrary
							.allocateTexture(R.drawable.enemy_rokudou_fight_hit01),
					Utils.framesToTime(24, 2), null, null);
			AnimationFrame hitFrame2 = new AnimationFrame(
					textureLibrary
							.allocateTexture(R.drawable.enemy_rokudou_fight_hit02),
					Utils.framesToTime(24, 1), null, null);
			AnimationFrame hitFrame3 = new AnimationFrame(
					textureLibrary
							.allocateTexture(R.drawable.enemy_rokudou_fight_hit03),
					Utils.framesToTime(24, 1), null, null);
			...
			die.addFrame(new AnimationFrame(textureLibrary
					...
					Utils.framesToTime(24, 6), null, null));
			die.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_rokudou_fight_die01),
					Utils.framesToTime(24, 2), null, null));
			die.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_rokudou_fight_die02),
					Utils.framesToTime(24, 4), null, null));
			die.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_rokudou_fight_die03),
					Utils.framesToTime(24, 6), null, null));
			die.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.enemy_rokudou_fight_die04),
					Utils.framesToTime(24, 6), null, null));
		...
		patrol.setReactToHits(true);
		patrol.setGameEvent(GameFlowEvent.EVENT_SHOW_ANIMATION,
				AnimationPlayerActivity.KABOCHA_ENDING, true);
		...
		if (sound != null) {
			hitReact.setTakeHitSound(HitType.HIT,
					sound.load(R.raw.sound_rokudou_hit));
		}
		...
		// HACK! Since there's no gravity and this is a big character, align him
		// to the floor
		// manually.
	...
	public GameObject spawnPlayerGhost(float positionX, float positionY,
			GameObject player, float lifeTime) {
		TextureLibrary textureLibrary = sSystemRegistry.longTermTextureLibrary;
		...
		if (staticData == null) {
			...
			// (GravityComponent)allocateComponent(GravityComponent.class);
			...
			FixedSizeArray<CollisionVolume> basicAttackVolume = new FixedSizeArray<CollisionVolume>(
					1);
			basicAttackVolume.add(new SphereCollisionVolume(32, 32, 32,
					HitType.POSSESS));

			SpriteAnimation idle = new SpriteAnimation(0, 4);
			idle.addFrame(new AnimationFrame(textureLibrary
					.getTextureByResource(R.drawable.effect_energyball01),
					Utils.framesToTime(24, 1), basicAttackVolume, null));
			idle.addFrame(new AnimationFrame(textureLibrary
					.getTextureByResource(R.drawable.effect_energyball02),
					Utils.framesToTime(24, 1), basicAttackVolume, null));
			idle.addFrame(new AnimationFrame(textureLibrary
					.getTextureByResource(R.drawable.effect_energyball03),
					Utils.framesToTime(24, 1), basicAttackVolume, null));
			idle.addFrame(new AnimationFrame(textureLibrary
					.getTextureByResource(R.drawable.effect_energyball04),
					Utils.framesToTime(24, 1), basicAttackVolume, null));
			idle.setLoop(true);
		...
		// when the ghost dies it either releases itself or passes control to
		// another object, so we
	...
	public GameObject spawnEnergyBall(float positionX, float positionY,
			boolean flipHorizontal) {
		TextureLibrary textureLibrary = sSystemRegistry.shortTermTextureLibrary;
		...
		if (staticData == null) {
			...
			FixedSizeArray<CollisionVolume> basicAttackVolume = new FixedSizeArray<CollisionVolume>(
					1);
			basicAttackVolume.add(new SphereCollisionVolume(16, 16, 16,
					HitType.HIT));

			SpriteAnimation idle = new SpriteAnimation(0, 4);
			idle.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.energy_ball01), Utils
					.framesToTime(24, 1), basicAttackVolume, null));
			idle.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.energy_ball02), Utils
					.framesToTime(24, 1), basicAttackVolume, null));
			idle.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.energy_ball03), Utils
					.framesToTime(24, 1), basicAttackVolume, null));
			idle.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.energy_ball04), Utils
					.framesToTime(24, 1), basicAttackVolume, null));
			idle.setLoop(true);
	...
	public GameObject spawnWandaShot(float positionX, float positionY,
			boolean flipHorizontal) {
		TextureLibrary textureLibrary = sSystemRegistry.shortTermTextureLibrary;
	...
	public GameObject spawnCannonBall(float positionX, float positionY,
			boolean flipHorizontal) {
		TextureLibrary textureLibrary = sSystemRegistry.shortTermTextureLibrary;
		...
		if (staticData == null) {
			...
			SpriteAnimation idle = new SpriteAnimation(0, 1);
			idle.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.snail_bomb), Utils
					.framesToTime(24, 1), basicAttackVolume, null));
	...
	public GameObject spawnTurretBullet(float positionX, float positionY,
			boolean flipHorizontal) {
		TextureLibrary textureLibrary = sSystemRegistry.shortTermTextureLibrary;
		...
		if (staticData == null) {
			...
			FixedSizeArray<CollisionVolume> basicAttackVolume = new FixedSizeArray<CollisionVolume>(
					1);
			basicAttackVolume.add(new SphereCollisionVolume(8, 8, 8,
					HitType.HIT));

			SpriteAnimation idle = new SpriteAnimation(0, 2);
			idle.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.effect_bullet01), Utils
					.framesToTime(24, 1), basicAttackVolume, null));
			idle.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.effect_bullet02), Utils
					.framesToTime(24, 1), basicAttackVolume, null));
			idle.setLoop(true);
	...
	public GameObject spawnBrobotBullet(float positionX, float positionY,
			boolean flipHorizontal) {
		TextureLibrary textureLibrary = sSystemRegistry.shortTermTextureLibrary;
	...
	public GameObject spawnCoin(float positionX, float positionY) {
		...
		if (staticData == null) {
			...
			idle.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.object_coin01), Utils
					.framesToTime(24, 30), null, basicVulnerabilityVolume));
			idle.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.object_coin02), Utils
					.framesToTime(24, 2), null, basicVulnerabilityVolume));
			idle.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.object_coin03), Utils
					.framesToTime(24, 2), null, basicVulnerabilityVolume));
			idle.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.object_coin04), Utils
					.framesToTime(24, 1), null, basicVulnerabilityVolume));
			idle.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.object_coin05), Utils
					.framesToTime(24, 2), null, basicVulnerabilityVolume));
			idle.setLoop(true);
		...
		// TODO: this is pretty dumb. The static data binding needs to be made
		// generic.
	...
	public GameObject spawnRuby(float positionX, float positionY) {
		...
		if (staticData == null) {
			...
			SpriteAnimation idle = new SpriteAnimation(0, 5);
			idle.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.object_ruby01), 2.0f, null,
					basicVulnerabilityVolume));
			idle.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.object_ruby02), Utils
					.framesToTime(24, 2), null, basicVulnerabilityVolume));
			idle.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.object_ruby03), Utils
					.framesToTime(24, 1), null, basicVulnerabilityVolume));
			idle.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.object_ruby04), Utils
					.framesToTime(24, 1), null, basicVulnerabilityVolume));
			idle.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.object_ruby05), Utils
					.framesToTime(24, 2), null, basicVulnerabilityVolume));
			idle.setLoop(true);
	...
	public GameObject spawnDiary(float positionX, float positionY) {
		...
		if (staticData == null) {
			...
			idle.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.object_diary01), 1.0f, null,
					basicVulnerabilityVolume));
			idle.addFrame(frame2);
			idle.addFrame(frame1);
			idle.addFrame(frame2);
			idle.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.object_diary03), Utils
					.framesToTime(24, 2), null, basicVulnerabilityVolume));
			idle.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.object_diary04), Utils
					.framesToTime(24, 2), null, basicVulnerabilityVolume));
			idle.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.object_diary05), Utils
					.framesToTime(24, 2), null, basicVulnerabilityVolume));
			idle.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.object_diary06), Utils
					.framesToTime(24, 2), null, basicVulnerabilityVolume));
	...
	public GameObject spawnObjectDoor(float positionX, float positionY,
			GameObjectType type, boolean solid) {
		TextureLibrary textureLibrary = sSystemRegistry.shortTermTextureLibrary;
		...
		if (staticData == null) {
			...
			final int red_frames[] = { R.drawable.object_door_red01,
					R.drawable.object_door_red02, R.drawable.object_door_red03,
			...
			AnimationFrame closeFrame2 = new AnimationFrame(
					textureLibrary.allocateTexture(frames[1]),
					Utils.framesToTime(24, 2), attackVolume,
					vulnerabilityVolume);

			SpriteAnimation idle_closed = new SpriteAnimation(
					DoorAnimationComponent.Animation.CLOSED, 1);
			idle_closed.addFrame(frame1);

			SpriteAnimation idle_open = new SpriteAnimation(
					DoorAnimationComponent.Animation.OPEN, 1);
			idle_open.addFrame(frame4);

			SpriteAnimation open = new SpriteAnimation(
					DoorAnimationComponent.Animation.OPENING, 2);
			open.addFrame(frame2);
			open.addFrame(frame3);

			SpriteAnimation close = new SpriteAnimation(
					DoorAnimationComponent.Animation.CLOSING, 2);
		...
		SolidSurfaceComponent solidSurface = object
				.findByClass(SolidSurfaceComponent.class);
		if (solid) {
	...
	public GameObject spawnObjectButton(float positionX, float positionY,
			GameObjectType type) {
		TextureLibrary textureLibrary = sSystemRegistry.shortTermTextureLibrary;
		...
		if (staticData == null) {
			...
			FixedSizeArray<CollisionVolume> vulnerabilityVolume = new FixedSizeArray<CollisionVolume>(
					1);
			...
			SpriteAnimation idle = new SpriteAnimation(
					ButtonAnimationComponent.Animation.UP, 1);
			idle.addFrame(frame1);

			SpriteAnimation pressed = new SpriteAnimation(
					ButtonAnimationComponent.Animation.DOWN, 1);
	...
	public GameObject spawnObjectCannon(float positionX, float positionY) {
		...
		if (staticData == null) {
			...
			SpriteAnimation idle = new SpriteAnimation(
					GenericAnimationComponent.Animation.IDLE, 1);
			idle.addFrame(frame1);
	...
	public GameObject spawnObjectBrobotSpawner(float positionX,
			float positionY, boolean flipHorizontal) {

		TextureLibrary textureLibrary = sSystemRegistry.shortTermTextureLibrary;

		// This is pretty heavy-handed.
		// TODO: figure out a general solution for objects that depend on other
		// objects.
		...
		if (staticData == null) {
			...
			SpriteAnimation idle = new SpriteAnimation(0, 1);
			idle.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.object_brobot_machine), 1.0f,
					null, basicVulnerabilityVolume));

			SolidSurfaceComponent solidSurface = (SolidSurfaceComponent) allocateComponent(SolidSurfaceComponent.class);
			solidSurface.inititalize(3);
			/*
			 * 0:2,0:8,59:-0.99532399996093,0.09659262446878
			 * 0:8,59:61,33:0.44551558813576,0.89527418187282 0:61,33:61,-1:1,0
			 */
			// trapezoid shape:
			// |\ |\2
			// | | 1| |3
	...
	public GameObject spawnObjectInfiniteSpawner(float positionX,
			float positionY) {
		GameObject object = spawnObjectBrobotSpawner(positionX, positionY,
				false);
		object.facingDirection.y = -1; // vertical flip
		LaunchProjectileComponent gun = object
				.findByClass(LaunchProjectileComponent.class);
		if (gun != null) {
	...
	public GameObject spawnObjectCrusherAndou(float positionX, float positionY) {
		...
		if (staticData == null) {
			...
			idle.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.andou_stand), 1.0f, null,
					basicVulnerabilityVolume));
	...
	public GameObject spawnObjectBreakableBlock(float positionX, float positionY) {
		...
		if (staticData == null) {
			...
			FixedSizeArray<CollisionVolume> basicVulnerabilityVolume = new FixedSizeArray<CollisionVolume>(
					1);
			basicVulnerabilityVolume.add(new AABoxCollisionVolume(7, 0, 32 - 7,
					42, HitType.HIT));

			SpriteAnimation idle = new SpriteAnimation(0, 1);
			idle.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.object_debris_block), 1.0f,
					null, basicVulnerabilityVolume));
	...
	public GameObject spawnObjectTheSource(float positionX, float positionY) {
		...
		layer1Fade.setTexture(textureLibrary
				.allocateTexture(R.drawable.enemy_source_spikes));
		layer1Fade.setupFade(1.0f, 0.2f, 1.9f,
				FadeDrawableComponent.LOOP_TYPE_PING_PONG,
				FadeDrawableComponent.FADE_EASE, 0.0f);
		...
		layer2Fade.setTexture(textureLibrary
				.allocateTexture(R.drawable.enemy_source_body));
		layer2Fade.setupFade(1.0f, 0.8f, 5.0f,
				FadeDrawableComponent.LOOP_TYPE_PING_PONG,
				FadeDrawableComponent.FADE_EASE, 0.0f);
		...
		layer3Fade.setTexture(textureLibrary
				.allocateTexture(R.drawable.enemy_source_black));
		layer3Fade.setupFade(0.0f, 1.0f, 6.0f,
				FadeDrawableComponent.LOOP_TYPE_PING_PONG,
				FadeDrawableComponent.FADE_LINEAR, 0.0f);
		...
		layer4Fade.setTexture(textureLibrary
				.allocateTexture(R.drawable.enemy_source_spots));
		layer4Fade.setupFade(0.0f, 1.0f, 2.3f,
				FadeDrawableComponent.LOOP_TYPE_PING_PONG,
				FadeDrawableComponent.FADE_EASE, 0.0f);
		...
		layer5Fade.setTexture(textureLibrary
				.allocateTexture(R.drawable.enemy_source_core));
		layer5Fade.setupFade(0.2f, 1.0f, 1.2f,
				FadeDrawableComponent.LOOP_TYPE_PING_PONG,
				FadeDrawableComponent.FADE_EASE, 0.0f);
		...
		FixedSizeArray<CollisionVolume> vulnerabilityVolume = new FixedSizeArray<CollisionVolume>(
				1);
		vulnerabilityVolume.add(new SphereCollisionVolume(256, 256, 256,
				HitType.HIT));
		FixedSizeArray<CollisionVolume> attackVolume = new FixedSizeArray<CollisionVolume>(
				1);
		...
		theSource.setGameEvent(GameFlowEvent.EVENT_SHOW_ANIMATION,
				AnimationPlayerActivity.WANDA_ENDING);
	...
	public GameObject spawnObjectSign(float positionX, float positionY) {
		...
		if (staticData == null) {
			...
			FixedSizeArray<CollisionVolume> basicVulnerabilityVolume = new FixedSizeArray<CollisionVolume>(
					1);
			basicVulnerabilityVolume.add(new AABoxCollisionVolume(8, 0, 24, 32,
					HitType.COLLECT));
	...
	public GameObject spawnObjectTurret(float positionX, float positionY,
			boolean flipHorizontal) {
		...
		if (staticData == null) {
			...
			SpriteAnimation idle = new SpriteAnimation(
					EnemyAnimations.IDLE.ordinal(), 2);
			idle.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.object_gunturret01), 1.0f,
					null, basicVulnerabilityVolume));
			idle.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.object_gunturret_idle), Utils
					.framesToTime(24, 1), null, basicVulnerabilityVolume));
			idle.setLoop(true);

			SpriteAnimation attack = new SpriteAnimation(
					EnemyAnimations.ATTACK.ordinal(), 4);
			attack.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.object_gunturret02), Utils
					.framesToTime(24, 1), null, basicVulnerabilityVolume));
			attack.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.object_gunturret01), Utils
					.framesToTime(24, 1), null, basicVulnerabilityVolume));
			attack.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.object_gunturret03), Utils
					.framesToTime(24, 2), null, basicVulnerabilityVolume));
			attack.addFrame(new AnimationFrame(textureLibrary
					.allocateTexture(R.drawable.object_gunturret01), Utils
					.framesToTime(24, 1), null, basicVulnerabilityVolume));
		...
		GhostComponent possessedGhost = object
				.findByClass(GhostComponent.class);
	...
	public GameObject spawnDust(float positionX, float positionY,
			boolean flipHorizontal) {
		TextureLibrary textureLibrary = sSystemRegistry.longTermTextureLibrary;
		...
		if (staticData == null) {
			...
			SpriteAnimation idle = new SpriteAnimation(0, 5);
			idle.addFrame(new AnimationFrame(textureLibrary
					.getTextureByResource(R.drawable.dust01), Utils
					.framesToTime(24, 1)));
			idle.addFrame(new AnimationFrame(textureLibrary
					.getTextureByResource(R.drawable.dust02), Utils
					.framesToTime(24, 1)));
			idle.addFrame(new AnimationFrame(textureLibrary
					.getTextureByResource(R.drawable.dust03), Utils
					.framesToTime(24, 1)));
			idle.addFrame(new AnimationFrame(textureLibrary
					.getTextureByResource(R.drawable.dust04), Utils
					.framesToTime(24, 1)));
			idle.addFrame(new AnimationFrame(textureLibrary
					.getTextureByResource(R.drawable.dust05), Utils
					.framesToTime(24, 1)));
	...
	public GameObject spawnEffectExplosionSmall(float positionX, float positionY) {
		...
		if (staticData == null) {
			...
			idle.addFrame(new AnimationFrame(textureLibrary
					.getTextureByResource(R.drawable.effect_explosion_small01),
					Utils.framesToTime(24, 1), basicAttackVolume, null));
			idle.addFrame(new AnimationFrame(textureLibrary
					.getTextureByResource(R.drawable.effect_explosion_small02),
					Utils.framesToTime(24, 1), basicAttackVolume, null));
			idle.addFrame(new AnimationFrame(textureLibrary
					.getTextureByResource(R.drawable.effect_explosion_small03),
					Utils.framesToTime(24, 1), basicAttackVolume, null));
			idle.addFrame(new AnimationFrame(textureLibrary
					.getTextureByResource(R.drawable.effect_explosion_small04),
					Utils.framesToTime(24, 1), basicAttackVolume, null));
			idle.addFrame(new AnimationFrame(textureLibrary
					.getTextureByResource(R.drawable.effect_explosion_small05),
					Utils.framesToTime(24, 1), basicAttackVolume, null));
			idle.addFrame(new AnimationFrame(textureLibrary
					.getTextureByResource(R.drawable.effect_explosion_small06),
					Utils.framesToTime(24, 1), basicAttackVolume, null));
			idle.addFrame(new AnimationFrame(textureLibrary
					.getTextureByResource(R.drawable.effect_explosion_small07),
					Utils.framesToTime(24, 1), basicAttackVolume, null));
	...
	public GameObject spawnEffectExplosionLarge(float positionX, float positionY) {
		...
		if (staticData == null) {
			...
			idle.addFrame(new AnimationFrame(textureLibrary
					.getTextureByResource(R.drawable.effect_explosion_big01),
					Utils.framesToTime(24, 1), basicAttackVolume, null));
			idle.addFrame(new AnimationFrame(textureLibrary
					.getTextureByResource(R.drawable.effect_explosion_big02),
					Utils.framesToTime(24, 1), basicAttackVolume, null));
			idle.addFrame(new AnimationFrame(textureLibrary
					.getTextureByResource(R.drawable.effect_explosion_big03),
					Utils.framesToTime(24, 1), basicAttackVolume, null));
			idle.addFrame(new AnimationFrame(textureLibrary
					.getTextureByResource(R.drawable.effect_explosion_big04),
					Utils.framesToTime(24, 1), basicAttackVolume, null));
			idle.addFrame(new AnimationFrame(textureLibrary
					.getTextureByResource(R.drawable.effect_explosion_big05),
					Utils.framesToTime(24, 1), basicAttackVolume, null));
			idle.addFrame(new AnimationFrame(textureLibrary
					.getTextureByResource(R.drawable.effect_explosion_big06),
					Utils.framesToTime(24, 1), basicAttackVolume, null));
			idle.addFrame(new AnimationFrame(textureLibrary
					.getTextureByResource(R.drawable.effect_explosion_big07),
					Utils.framesToTime(24, 1), basicAttackVolume, null));
			idle.addFrame(new AnimationFrame(textureLibrary
					.getTextureByResource(R.drawable.effect_explosion_big08),
					Utils.framesToTime(24, 1), basicAttackVolume, null));
			idle.addFrame(new AnimationFrame(textureLibrary
		...
		soundEffect.setSound(sSystemRegistry.soundSystem
				.load(R.raw.quick_explosion));
	...
	public GameObject spawnEffectExplosionGiant(float positionX, float positionY) {
		...
		if (staticData == null) {
			...
			FixedSizeArray<CollisionVolume> basicAttackVolume = new FixedSizeArray<CollisionVolume>(
					1);
			basicAttackVolume.add(new SphereCollisionVolume(64, 32, 32,
					HitType.HIT));
			...
			smallBlast2.addFrame(new AnimationFrame(null, Utils.framesToTime(
					24, 4), null, null));
			...
			smallBlast3.addFrame(new AnimationFrame(null, Utils.framesToTime(
					24, 8), null, null));
		...
		// Hack. Use static data differently for this object so we can share
		// three animations
		...
		LifetimeComponent lifetime = (LifetimeComponent) allocateComponent(LifetimeComponent.class);
		lifetime.setTimeUntilDeath(Math.max(Math.max(
				Math.max(idle.getLength(), smallBlast1.getLength()),
				smallBlast2.getLength()), smallBlast3.getLength()));
		...
		object.team = Team.PLAYER; // Maybe this should be an argument to this
									// function.
	...
	public GameObject spawnEffectSmokeBig(float positionX, float positionY) {
		...
		// This is just an effect, so we can live without it if our pools are
		// exhausted.
		if (componentAvailable(RenderComponent.class, 1)) {
			...
			if (staticData == null) {
				...
				AnimationFrame frame2 = new AnimationFrame(
						textureLibrary
								.getTextureByResource(R.drawable.effect_smoke_big02),
						Utils.framesToTime(24, 1), null, null);

				AnimationFrame frame3 = new AnimationFrame(
						textureLibrary
								.getTextureByResource(R.drawable.effect_smoke_big03),
						Utils.framesToTime(24, 1), null, null);
				...
				AnimationFrame frame5 = new AnimationFrame(
						textureLibrary
								.getTextureByResource(R.drawable.effect_smoke_big05),
						Utils.framesToTime(24, 1), null, null);

				SpriteAnimation idle = new SpriteAnimation(0, 5);
				idle.addFrame(new AnimationFrame(textureLibrary
						.getTextureByResource(R.drawable.effect_smoke_big01),
						Utils.framesToTime(24, 10), null, null));
				idle.addFrame(frame2);
				idle.addFrame(frame3);
				idle.addFrame(frame4);
				...
				idle2.addFrame(new AnimationFrame(textureLibrary
						.getTextureByResource(R.drawable.effect_smoke_big01),
				...
				idle3.addFrame(new AnimationFrame(textureLibrary
						.getTextureByResource(R.drawable.effect_smoke_big01),
						Utils.framesToTime(24, 8), null, null));
				...
				idle4.addFrame(new AnimationFrame(textureLibrary
						.getTextureByResource(R.drawable.effect_smoke_big01),
				...
				idle5.addFrame(new AnimationFrame(textureLibrary
						.getTextureByResource(R.drawable.effect_smoke_big01),
			...
			final int animIndex = (int) (Math.random() * sprite
					.getAnimationCount());
	...
	public GameObject spawnEffectSmokeSmall(float positionX, float positionY) {
		...
		if (componentAvailable(RenderComponent.class, 1)) {
			...
			if (staticData == null) {
				...
				SpriteAnimation idle = new SpriteAnimation(0, 5);
				idle.addFrame(new AnimationFrame(textureLibrary
						.getTextureByResource(R.drawable.effect_smoke_small01),
						Utils.framesToTime(24, 10), null, null));
				idle.addFrame(new AnimationFrame(textureLibrary
						.getTextureByResource(R.drawable.effect_smoke_small02),
						Utils.framesToTime(24, 1), null, null));
				idle.addFrame(new AnimationFrame(textureLibrary
						.getTextureByResource(R.drawable.effect_smoke_small03),
						Utils.framesToTime(24, 1), null, null));
				idle.addFrame(new AnimationFrame(textureLibrary
						.getTextureByResource(R.drawable.effect_smoke_small04),
						Utils.framesToTime(24, 1), null, null));
				idle.addFrame(new AnimationFrame(textureLibrary
						.getTextureByResource(R.drawable.effect_smoke_small05),
						Utils.framesToTime(24, 1), null, null));
	...
	public GameObject spawnEffectCrushFlash(float positionX, float positionY) {
		...
		if (componentAvailable(RenderComponent.class, 1)) {
			...
			if (staticData == null) {
				...
				back.addFrame(new AnimationFrame(textureLibrary
						.getTextureByResource(R.drawable.effect_crush_back01),
						Utils.framesToTime(24, 1), null, null));
				back.addFrame(new AnimationFrame(textureLibrary
						.getTextureByResource(R.drawable.effect_crush_back02),
						Utils.framesToTime(24, 1), null, null));
				back.addFrame(new AnimationFrame(textureLibrary
				...
				front.addFrame(new AnimationFrame(textureLibrary
						.getTextureByResource(R.drawable.effect_crush_front01),
						Utils.framesToTime(24, 1), null, null));
				front.addFrame(new AnimationFrame(textureLibrary
						.getTextureByResource(R.drawable.effect_crush_front02),
						Utils.framesToTime(24, 1), null, null));
				front.addFrame(new AnimationFrame(textureLibrary
						.getTextureByResource(R.drawable.effect_crush_front03),
						Utils.framesToTime(24, 1), null, null));
				front.addFrame(new AnimationFrame(textureLibrary
						.getTextureByResource(R.drawable.effect_crush_front04),
						Utils.framesToTime(24, 1), null, null));
				front.addFrame(new AnimationFrame(textureLibrary
						.getTextureByResource(R.drawable.effect_crush_front05),
						Utils.framesToTime(24, 1), null, null));
				front.addFrame(new AnimationFrame(textureLibrary
						.getTextureByResource(R.drawable.effect_crush_front06),
						Utils.framesToTime(24, 1), null, null));
				front.addFrame(new AnimationFrame(textureLibrary
						.getTextureByResource(R.drawable.effect_crush_front07),
						Utils.framesToTime(24, 1), null, null));
	...
	public GameObject spawnBreakableBlockPiece(float positionX, float positionY) {
		...
		if (staticData == null) {
			...
			DrawableBitmap piece = new DrawableBitmap(
					textureLibrary
							.getTextureByResource(R.drawable.object_debris_piece),
					(int) object.width, (int) object.height);
	...
	public GameObject spawnBreakableBlockPieceSpawner(float positionX,
			float positionY) {
	...
	public GameObject spawnGemEffect(float positionX, float positionY) {
		...
		fadeOut.setupFade(1.0f, 0.0f, 0.5f,
				FadeDrawableComponent.LOOP_TYPE_NONE,
				FadeDrawableComponent.FADE_LINEAR, 0.0f);
		fadeOut.setTexture(textureLibrary
				.allocateTexture(R.drawable.object_ruby01));
