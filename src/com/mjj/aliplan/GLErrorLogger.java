...
public class GLErrorLogger implements GLSurfaceView.GLWrapper {
	...
	static class ErrorLoggingGL implements GL, GL10, GL10Ext, GL11, GL11Ext {
		...
		public void checkError() {
			...
			if (error != GL10.GL_NO_ERROR) {
				String method = Thread.currentThread().getStackTrace()[3]
						.getMethodName();
				DebugLog.d("GL ERROR",
						"Error: " + error + " (" + GLU.gluErrorString(error)
								+ "): " + method);
			}
		...
		public void glCompressedTexImage2D(int target, int level,
			...
			((GL10) mGL).glCompressedTexImage2D(target, level, internalformat,
		...
		public void glCompressedTexSubImage2D(int target, int level,
				...
				int imageSize, Buffer data) {
			((GL10) mGL).glCompressedTexSubImage2D(target, level, xoffset,
		...
		public void glCopyTexImage2D(int target, int level, int internalformat,
			...
			((GL10) mGL).glCopyTexImage2D(target, level, internalformat, x, y,
					width, height, border);
			checkError();
		...
		public void glCopyTexSubImage2D(int target, int level, int xoffset,
			...
			((GL10) mGL).glCopyTexSubImage2D(target, level, xoffset, yoffset,
					x, y, width, height);
			checkError();
		}
		...
		public void glTexImage2D(int target, int level, int internalformat,
				...
				Buffer pixels) {
			((GL10) mGL).glTexImage2D(target, level, internalformat, width,
		...
		public void glTexSubImage2D(int target, int level, int xoffset,
				...
				Buffer pixels) {
			((GL10) mGL).glTexSubImage2D(target, level, xoffset, yoffset,
		...
		public int glQueryMatrixxOES(int[] arg0, int arg1, int[] arg2, int arg3) {
			int result = ((GL10Ext) mGL).glQueryMatrixxOES(arg0, arg1, arg2,
					arg3);
			checkError();
			return result;
		}
