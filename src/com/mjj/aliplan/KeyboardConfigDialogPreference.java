...
public class KeyboardConfigDialogPreference extends DialogPreference implements
		OnKeyListener {
	...
	protected void onBindDialogView(View view) {
		...
		if (mSharedPrefs != null) {
			mLeftKeyCode = mSharedPrefs.getInt(mLeftPrefKey,
					KeyEvent.KEYCODE_DPAD_LEFT);
			mRightKeyCode = mSharedPrefs.getInt(mRightPrefKey,
					KeyEvent.KEYCODE_DPAD_RIGHT);
			mJumpKeyCode = mSharedPrefs.getInt(mJumpPrefKey,
					KeyEvent.KEYCODE_SPACE);
			mAttackKeyCode = mSharedPrefs.getInt(mAttackPrefKey,
			...
			mLeftBorder.setOnClickListener(new ConfigClickListener(
					R.id.key_left));
			mRightBorder.setOnClickListener(new ConfigClickListener(
					R.id.key_right));
			mJumpBorder.setOnClickListener(new ConfigClickListener(
					R.id.key_jump));
			mAttackBorder.setOnClickListener(new ConfigClickListener(
					R.id.key_attack));

			mUnselectedBorder = mContext.getResources().getDrawable(
					R.drawable.key_config_border);
			mSelectedBorder = mContext.getResources().getDrawable(
					R.drawable.key_config_border_active);
		}
	...
	protected String getKeyLabel(int keycode) {
		...
		if (mKeyLabels == null) {
			mKeyLabels = mContext.getResources().getStringArray(
					R.array.keycode_labels);
		}
